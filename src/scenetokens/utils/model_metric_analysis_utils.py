...
def _distribution_shift_to_tex_table(  # noqa: PLR0912, PLR0913, PLR0915
    ...
    latex_lines.append("\\caption{Distribution Shift Results}")
    latex_lines.append("\\label{tab:distribution_shift_results}")
    ...
    latex_lines.append(" & & & " + " & ".join([*metrics, "", "", *metrics]) + " \\\\")
    latex_lines.append("\\midrule")
    latex_lines.extend(table_rows)
